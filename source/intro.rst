...
**NextGIS GeoServices on-premise** - это самостоятельное веб-приложение, предоставляющее пользователям доступ к высоконагруженным тайловым сервисам и предназначенное для развертывания на собственном сервере внутри организации.
...
.. figure:: _static/gs_overview_ru.png
   :name: gs_overview_pic
   :align: center
   :width: 20cm
...
В разделе **Обзор** размещается общая информация по созданным сервисам.
