...
После удаления сервиса кэш устаётся. Администратор может `удалить его вручную <https://docs.nextgis.ru/docs_geoserv_prem/source/admin.html#nggs-prem-admin-cache>`_.
