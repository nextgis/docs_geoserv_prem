...
После удаления сервиса остаётся его кэш. Администратор может `удалить кэш вручную <https://docs.nextgis.ru/docs_geoserv_prem/source/admin.html#nggs-prem-admin-cache>`_.
