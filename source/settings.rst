...
Данные для базовой карты можно загрузить в формате PBF (можно `заказать на NextGIS Data <https://data.nextgis.com/ru/region/custom/base/>`_) или выбрать территорию из списка.
