...
Если вы не вносили никакие изменения в кофигурацию, вы можете вместо этого скачать актуальный шаблон конфигурации (`docker-compose-2.21.0.tar.bz2 <https://nextgis.com/onpremise/geoservices/docker-compose-2.21.0.tar.bz2>`_, где 2.21.0 - текущая версия) и распаковать его. Если установка производится на сервере без доступа в Интернет, скачайте файл на другом ПК и перенесите его на сервер.
